...
const SERVICES = [
  ...
  { icon: Heart, title: 'Kumbh & Ark Vivah', desc: 'Traditional pre-marriage ritual described for certain severe Manglik Dosha situations.' },
  { icon: Sparkles, title: 'Guru Chandal Dosh Puja', desc: 'Traditional Puja associated with the Guru–Rahu combination in a Kundli.' },
  { icon: Star, title: 'Angarak Dosh Puja', desc: 'Traditional Graha Shanti-oriented Puja associated with the Mangal–Rahu combination.' },
